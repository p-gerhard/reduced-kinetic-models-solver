...
#define M1_MAX_KAPPA_SIMPLE 60.F
...
{
	float chi = evaluate_rational_simple(chi_p, chi_q, 7, r);
	/* @TODO : return chi so equivalent kappa = M1_MAX_KAPPA_SIMPLE */
	chi = fmax(0.5f, fmin(chi, 1.f));
